    ...
    <>
      <Box sx={{ display: "flex", alignItems: "center", flexDirection: "column"}}>
        <Box p={2} >
          ...
          >
            <DescriptionRounded
              sx={{ fontSize: 80, color: "#4e5dad", mt: 2, ml: 2 }}
            />
            <Stack p={3} pt={0}>
              <Typography fontWeight="bold" variant="h4" opacity="0.5">
                TEXT SUMAMRY
              </Typography>
        ...
        <Box p={2}>
          ...
          >
            ...
            <Stack p={3} pt={0}>
              ...
              <Typography variant="h5">Chat With AI Chatbot</Typography>
            </Stack>
          </Card>
        </Box>
        <Box p={2}>
        ...
        <Box p={2}>
          ...
          >
            ...
            <Stack p={3} pt={0}>
              ...
              <Typography variant="h5">Generate Scifi images</Typography>
            </Stack>
          </Card>
        </Box>
      </Box>
